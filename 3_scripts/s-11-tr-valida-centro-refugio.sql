...
--@Descripción: Trigger que valida que un centro operativo asociado a la entidad centro refugio sea un centro refugio

create or replace trigger trg_valida_centro_refugio
before insert or update of centro_operativo_id on centro_refugio
for each row
declare 
